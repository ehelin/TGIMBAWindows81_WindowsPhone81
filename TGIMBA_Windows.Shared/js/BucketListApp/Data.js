function GetBucketList(userName, sessionSortDirectionKey, sessionSortOperation, token, isMobile) {
    ...
    var result = CallService('/Services/BucketListServices.svc/GetBucketListItems',
                            'post',
...
function UpsertBucketListItem(bucketListItems, userName, token, isMobile) {
    ...
    var result = CallService('/Services/BucketListServices.svc/UpsertBucketListItem',
                            'post',
                                'application/json; charset=utf-8',
                                JSON.stringify({
